...
def search(request):
    ...
    s_amenties = request.GET.getlist("amenties")
    ...
    amenties = models.Amenity.objects.all()
    ...
    if len(s_amenties) > 0:
        for s_amenity in s_amenties:
            filter_args["amenties__pk"] = int(s_amenity)
